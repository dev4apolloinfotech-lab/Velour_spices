...
<table
    style="width: 100%; max-width: 750px; margin: auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; font-family: 'Segoe UI', sans-serif; border: 3px solid #c5470b; box-shadow: 0 0 12px rgba(42, 125, 62, 0.2);">

    <!-- Header -->
    <tr>
        <td style="padding: 30px; text-align: center; color: #000;">
            <img src="https://getdemo.in/Velour_spices/assets/front/assets/image/velour-01.png" alt="OroVeda Logo"
                style="width: 180px; margin-bottom: 10px;">
            <h2 style="margin: 0; font-size: 24px; color: #c5470b;">Thank you for your order!</h2>
            <p style="margin: 5px 0 0; font-size: 14px; color: #666;">{{ config('app.name') }}</p>
        </td>
    </tr>
    <tr>
        <td>
            <hr style="border: 1px solid #c5470b;">
        </td>
    </tr>
    ...
    <tr>
        <td style="padding: 25px;">
            <h3 style="margin: 0 0 15px; font-size: 20px; color: #c5470b; border-bottom: 2px solid #d4af37;">Customer
                Details</h3>
    ...
    <tr>
        <td
            style="background: linear-gradient(135deg, #c5470b, #c5470b); color: white; padding: 10px 20px; font-size: 18px; font-weight: bold;">
            Order Summary
        </td>
    </tr>
    ...
    <tr>
        <td style="padding: 20px;">
            <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                <thead>
                    <tr style="background-color: #c5470b; font-weight: bold; color: white;">
                ...
                <tbody>
                    ...
                    @foreach ($OrderDetail as $cartItem)
                        <tr style="background-color: {{ $i % 2 == 0 ? '#f6fff6' : '#e8f5e9' }};">
                            ...
                            <td style="padding: 10px; text-align: center;">
                                <img src="https://getdemo.in/Velour_spices/uploads/product/thumbnail/{{ $cartItem->photo }}"
                    ...
                    <tr style="background-color: #c5470b; font-weight: bold; color: #000;">
                        <td colspan="5"></td>
                    ...
                    <tr style="background: linear-gradient(135deg, #c5470b, #c5470b); font-weight: bold; color: white;">
                        <td colspan="5"></td>
    ...
    <tr>
        <td style="padding: 20px; background-color: #f6f6f6; text-align: center; font-size: 13px; color: #555;">
            ...
            <p style="margin: 5px 0;">Need help? Call <strong style="color: #c5470b;">+91 63569 33345</strong></p>
            <p style="margin: 5px 0; color: #c5470b;">&copy; {{ now()->year }} {{ config('app.name') }} | Crafted
                with 🧡 by Velour Spices</p>
        </td>
    </tr>
</table>
