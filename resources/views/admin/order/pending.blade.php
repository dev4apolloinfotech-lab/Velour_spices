                                                                ...
                                                                <table id="scroll-horizontal"
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="all">Shiprocket Status</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <?php
                                                                        ...
                                                                        @foreach ($Pending as $pending)
                                                                            ...
                                                                            <tr class="text-center"
                                                                                ...
                                                                                <td>{{ $pending->shiprocket_status ?? '' }}</td>
                                                                            ...
                                                                            @foreach ($detail as $item)
                                                                                ...
                                                                                <tr class="text-center"
                                                                                    ...
                                                                                    <td colspan="2"
                                                                                        ...
                                                                                        data-title="Qty">
                                                                                        {{ $ProductAttribute && $ProductAttribute->product_attribute_qty && $ProductAttribute->name
                                                                                            ? $ProductAttribute->product_attribute_qty . ' (' . $ProductAttribute->name . ')'
                                                                                            : '-' }}
                                                                                    </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="10" class="des-ll">
                                                                                    <div
                                                                                        ...
                                                                                        <!--@if($pending->shiprocket_status == 'CANCELED')-->
                                                                                        
                                                                                        <!-- <a href="{{ route('shiprocket_status', $pending->order_id) }}"-->
                                                                                           
                                                                                        <!--    class="mx-2" title="Push To ShipPocket">-->
                                                                                        <!--    <i-->
