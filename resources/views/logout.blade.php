...
<head>
    ...
    <meta charset="utf-8" />
    <title>{{ env('APP_NAME') }} | Log Out </title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Themesbrand" name="author" />
    <!-- App favicon -->
    <link rel="icon" type="image/png" href="{{ asset('assets/front/images/velour-logo.png') }}">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <img src="{{ asset('assets/images/velour-logo.png') }}" alt="" height="190">
                            </div>
                        </div>
                    </div>
                </div>
